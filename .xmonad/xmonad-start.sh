...
myHDMI=HDMI-1
myDisplayport=DP-1
# ifne needs 'sudo apt install moreutils'
#xrandr | grep $myHDMI\ connected | ifne xrandr --output $myHDMI --auto --right-of $myDisplay
...
/home/mahene/.dotfiles/xmonad/xmonad-starthook.sh
